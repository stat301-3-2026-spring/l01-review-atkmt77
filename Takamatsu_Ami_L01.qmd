...
- Define recipes 
- Define models
- Fitting models to the training dataset
- Fittitng models to the testing dataset
...
Supervised learning involves automatic data pattern detection on pre-categorized data, where outcome y is not required. It consists of parametric and non-parametric models. For unsupervised learning, it involves pattern and structure recognition on unlabeled data. 
...
Usually Parametric models, make assumptions on f(x)
...
Having no assumption about f(x)
...
Parametric models are mechanistic models, nonparametric models are empirically driven models 
